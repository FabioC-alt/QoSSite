...
def process_queue():
    """Continuously processes high-priority first, then low-priority requests."""
    while True:
        request_data = None
        try:
            with queue_lock:
    ...
    while True:
        try:
            ...
            with open(LOG_FILE, "a", newline="") as f:
                writer = csv.writer(f)
                writer.writerow([timestamp, total_queue, high_in_high, low_in_high, high_in_low, low_in_low, dropped_high_in_low, dropped_low])
